...
Abase1a = 0.2;
Atarget1a = 0:0.1:1;
[E1a] = E_computation(Abase1a, Atarget1a, Amax);
% medium baseline
Abase1b = 0.5;
Atarget1b = 0:0.1:1;
[E1b] = E_computation(Abase1b, Atarget1b, Amax);
% high baseline
Abase1c = 0.8;
Atarget1c = 0:0.1:1;
[E1c] = E_computation(Abase1c, Atarget1c, Amax);
...
Abase2a = 0:0.1:1;
Atarget2a = 0.2;
[E2a] = E_computation(Abase2a, Atarget2a, Amax);
% medium target
Abase2b = 0:0.1:1;
Atarget2b = 0.5;
[E2b] = E_computation(Abase2b, Atarget2b, Amax);
% high target
Abase2c = 0:0.1:1;
Atarget2c = 0.8;
[E2c] = E_computation(Abase2c, Atarget2c, Amax);
...
line([Abase1a, Abase1a],ylim(),'LineWidth',1','Color',col1,'LineStyle','-');
line([Abase1b, Abase1b],ylim(),'LineWidth',1','Color',col1,'LineStyle','-');
line([Abase1c, Abase1c],ylim(),'LineWidth',1','Color',col1,'LineStyle','-');
xlabel('A target');
ylabel('E');
...
line([Atarget2a, Atarget2a],ylim(),'LineWidth',1','Color',col1,'LineStyle','-');
line([Atarget2b, Atarget2b],ylim(),'LineWidth',1','Color',col2,'LineStyle','-');
line([Atarget2c, Atarget2c],ylim(),'LineWidth',1','Color',col3,'LineStyle','-');
xlabel('A baseline');
ylabel('E');
